  ...
  return (
    <div className='pt-16'>
      <div className="main-font h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-main-background text-center">
        <h1 className="text-6xl font-medium text-gray-800 mb-8">RCM Help</h1>
        <p className="text-lg max-w-md text-gray-600 mb-12 px-4">
          Here to help you practice RCM material, while also providing tests to aid in preparation for an RCM exam
        </p>

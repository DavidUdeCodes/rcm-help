...
// Four Note Chords (doubled root, e.g. C-E-G-C)
const FOUR_NOTE_CHORDS = [
  // Major
  { name: "Major 4-note (Root)", group: "Four Note Chords", intervals: [0, 4, 7, 12] },      // C E G C
  { name: "Major 4-note (1st Inv)", group: "Four Note Chords", intervals: [4, 7, 12, 16] },  // E G C E
  { name: "Major 4-note (2nd Inv)", group: "Four Note Chords", intervals: [7, 12, 16, 19] }, // G C E G
  // Minor
  { name: "Minor 4-note (Root)", group: "Four Note Chords", intervals: [0, 3, 7, 12] },      // C Eb G C
  { name: "Minor 4-note (1st Inv)", group: "Four Note Chords", intervals: [3, 7, 12, 15] },  // Eb G C Eb
  { name: "Minor 4-note (2nd Inv)", group: "Four Note Chords", intervals: [7, 12, 15, 19] }, // G C Eb G
];
...
const SEVENTHS = [
  ...
  { name: "Minor 7th (Root)", group: "Seventh Chords", intervals: [0, 3, 7, 10] },
  { name: "Minor 7th (1st Inv)", group: "Seventh Chords", intervals: [3, 7, 10, 12] },
  { name: "Minor 7th (2nd Inv)", group: "Seventh Chords", intervals: [7, 10, 12, 15] },
  { name: "Minor 7th (3rd Inv)", group: "Seventh Chords", intervals: [10, 12, 15, 19] },
...
const CHORDS = [...TRIADS, ...FOUR_NOTE_CHORDS, ...SEVENTHS];

// RCM Level 10 preset (no 7th chord inversions)
const RCM10_CHORDS = [
  "Major 4-note (Root)",
...
export default function ChordTest() {
  ...
  const [selectedChords, setSelectedChords] = useState(TRIADS.map(c => c.name));
